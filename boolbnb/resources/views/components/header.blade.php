...
@auth
          ...
          <div class="dropdown ">
            ...
            <button class="btn btn-secondary dropdown-toggle funziono" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Utente
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <li><a class="accesso_effettuato sinistra" href="{{route('user_apartments')}}">I Miei Appartamenti</a></li>
              <li><a class="accesso_effettuato destra" href="{{route('show_messages')}}">I miei Messaggi</a></li>

              <li>  <button class="dropdown-item ciaoci" style=color:"green" href="{{ route('logout') }}"
